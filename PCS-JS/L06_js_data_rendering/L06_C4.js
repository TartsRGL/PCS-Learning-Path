...
function handleFormInput(event, dom) {
  ...
  /* Commit 3 – Re-render project summary output on field input */
  renderProjectSummary(dom, appState);
}
...
/*
 * Commit 4 – Finalize data rendering lesson
 * L06 ends with:
 * - an output area DOM contract for project summary rendering
 * - pure state-to-DOM rendering for all project summary fields
 * - live re-rendering on field input while preserving fallback copy
 * - validation logic intact alongside live UI output rendering
 */
