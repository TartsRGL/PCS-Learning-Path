...
/*
 * Commit 4 – Finalize state management basics lesson
 * L04 ends with:
 * - an initial application state as the source of truth
 * - semantic mapping from discovery field intent to appState keys
 * - raw field values stored in the matching appState property
 * - submissionStatus remaining idle for a later lesson
 */
