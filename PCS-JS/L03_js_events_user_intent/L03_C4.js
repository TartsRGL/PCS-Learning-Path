...
/*
 * Commit 4 – Finalize events and user intent lesson
 * L03 ends with:
 * - submit intent recognition (preventing default reload)
 * - delegated input event recognition (using a single listener on form)
 * - discovery field filtering (isDiscoveryField)
 * - semantic field intent identification (getDiscoveryFieldIntent via stable data-js hooks)
 */
